  ...
  return (
    <footer className="bg-gray-800 text-white">
      <div className="container mx-auto py-10 px-4 sm:px-6 lg:px-8 text-center">
        <h3 className="text-2xl font-bold">NST Global Solar and Wind Energy Pvt Ltd</h3>
        <p className="text-gray-400 mt-2">Empowering a Sustainable Tomorrow.</p>
        ...
        <div className="mt-8 border-t border-gray-700 pt-6">
            <p className="text-sm text-gray-400">&copy; {new Date().getFullYear()} NST Global Solar and Wind Energy Pvt Ltd. All Rights Reserved.</p>
        </div>
      </div>
    </footer>
  );
